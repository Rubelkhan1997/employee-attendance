<div class="row">
    <div class="col-md-12">
        <div class="box">
            ...
            <!-- form start -->
            <form action="{{ url('/admin/employees') }}" method="post" class="form-horizontal edit-employee-form" accept-charset="UTF-8" enctype="multipart/form-data">
                <div class="box-body">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="full_name" value="{{ $employee->full_name }}" class="form-control" placeholder="Enter your full name" required> 
                                </div>
                            </div>
                            @error('full_name')
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                                    <input type="text" name="name" value="{{ $employee->name }}" class="form-control"  placeholder="Enter your first name" required> 
                                </div>
                            </div>
                            @error('name')
                                <span class="text-danger pb-1">{{ $message }}</span>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                                    <input type="email" name="email" value="{{ $employee->email }}" class="form-control"  placeholder="Enter your email" required> 
                                </div>
                            </div>
                            @error('email')
                                <span class="text-danger pb-1">{{ $message }}</span>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                                    <input type="text" name="address" value="{{ @$employee->employee_details->address }}" class="form-control"  placeholder="Enter your address" required> 
                                </div>
                            </div>
                            @error('address')
                                <span class="text-danger pb-1">{{ $message }}</span>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <table class="table table-hover" style="margin-bottom: 0px">
                                    ...
                                    @php
                                    $employee_contacts =  @$employee->employee_contacts;
                                    @endphp
                                    <tbody class="append_field">
                                        @foreach((object) $employee_contacts as $index => $contact)
                                        <tr class="file_count">
                                            <td width="30%"><input type="text"  name="c_name[]"   value="{{ @$contact->contact_name }}" class="form-control" placeholder="Enter name" required></td>
                                            <td width="30%"><input type="text"  name="c_mobile[]" value="{{ @$contact->contact_phone }}" class="form-control" placeholder="Enter mobile" required></td>  
                                            <td width="30%"><input type="email" name="c_email[]"  value="{{ @$contact->contact_email }}" class="form-control" placeholder="Enter email" required></td>
                                            <td>
                                                @if ($index != 0)
                                    ...
                                    <tfoot class="add_field" style="{{ count($employee_contacts) >= 2? 'display:none': '' }}">
                                        <tr>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="checkbox" name="status"  value="1"  {{ $employee->status? 'checked' : '' }}>
                                @error('status')
                                    <span class="text-danger pb-1">{{ $message }}</span>
                                @enderror
                            </div>
...
<script>
    ...
    let count = "{{ count($employee_contacts) }}";
    function add_field(){
